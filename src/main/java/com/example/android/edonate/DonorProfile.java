 ...
 * {@link DonorProfile.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link DonorProfile#newInstance} factory method to
...
public class DonorProfile extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.donor_profile, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        Name = (TextView)getView().findViewById(R.id.donorName);
        CellNo = (TextView)getView().findViewById(R.id.donorCellNo);
        EditInformation = (Button)getView().findViewById(R.id.edit_donor_info);
